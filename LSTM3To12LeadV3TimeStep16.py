...
# LSTM model to convert 3 leads Lead I, Lead II and V3 to five precordial leads V1, V2, V4, V5 and V6.
...
# data will be stored in ../DNN/dataOutLSTM16V3/ folder. 
...
for var1 in range(totalData):
	...
	addOut = '../DNN/dataOutLSTM16V3/dataOut%i.mat' %var1
...
for var1 in range(totalData):
	...
	filepath = '../DNN/dataOutLSTM16V3/bestweights.hdf5'                                            # For loading the weights
	...
	print('-' * 100);
	print('----------------------------LSTM Completed for inDataTrain', var1);
	print('-' * 100);

print('-' * 100);
print("""----------------------------   LSTM 16 Time Steps Completed ----------------------------""");
print('-' * 100);
