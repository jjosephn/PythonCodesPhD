...
# GRU model to convert 3 leads Lead I, Lead II and V3 to five precordial leads V1, V2, V4, V5 and V6.
...
# data will be stored in ../DNN/dataOutGRU16V3/ folder. 
...
for var1 in range(totalData):
	...
	addOut = '../DNN/dataOutGRU16V3/dataOut%i.mat' %var1
...
for var1 in range(totalData):
	...
	filepath = '../DNN/dataOutGRU16V3/bestweights.hdf5'                                            # For loading the weights
	...
	print('-' * 100);
	print('----------------------------GRU Completed for inDataTrain', var1);
	print('-' * 100);

print('-' * 100);
print("""----------------------------   GRU 16 Time Steps Completed ----------------------------""");
print('-' * 100);
